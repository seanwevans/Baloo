; src/sha384sum.asm -- compute a SHA-384 digest, coreutils output format.
; Usage: sha384sum [FILE]   (reads stdin when no FILE is given)
...
sha_k:
    ...
    dash db "-", 0
    newline db 10
    err_open db "sha384sum cannot open input", 10
